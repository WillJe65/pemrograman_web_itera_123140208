...
- **➕ Tambah Buku** - Input judul, penulis, dan status buku
- **✏️ Edit Buku** - Ubah informasi buku yang sudah ada
- **🗑️ Hapus Buku** - Hapus buku dengan konfirmasi modal
- **🔍 Pencarian** - Cari buku berdasarkan judul atau penulis
- **🏷️ Filter Status** - Filter: Semua, Dimiliki, Sedang Dibaca, Ingin Dibeli
